...
function createServerReference(id) {
  return client_edgeExports.createServerReference(id);
}
const clientReferences = {
  "f29e6e234fea": async () => {
    const m = await import("./assets/worker-entry-B6ROcTm4.js");
  ...
  "95cf9d25c5b0": async () => {
    const m = await import("./assets/worker-entry-B6ROcTm4.js");
    return m.export_95cf9d25c5b0;
  },
  "7d3ad4055eb6": async () => {
    const m = await import("./assets/worker-entry-B6ROcTm4.js");
    return m.export_7d3ad4055eb6;
  },
  "b58f9b9bb6a4": async () => {
    const m = await import("./assets/worker-entry-B6ROcTm4.js");
    return m.export_b58f9b9bb6a4;
  },
  "de2917a3ab24": async () => {
    const m = await import("./assets/worker-entry-B6ROcTm4.js");
    return m.export_de2917a3ab24;
  },
  "d96d33eba807": async () => {
    const m = await import("./assets/worker-entry-B6ROcTm4.js");
    return m.export_d96d33eba807;
  },
  "4b21b0276245": async () => {
    const m = await import("./assets/worker-entry-B6ROcTm4.js");
    return m.export_4b21b0276245;
  },
  "ab9335e7f626": async () => {
    const m = await import("./assets/worker-entry-B6ROcTm4.js");
    return m.export_ab9335e7f626;
  },
  "b0e839616971": async () => {
    const m = await import("./assets/worker-entry-B6ROcTm4.js");
    return m.export_b0e839616971;
  },
  "cf9a10ca1a61": async () => {
    const m = await import("./assets/worker-entry-B6ROcTm4.js");
    return m.export_cf9a10ca1a61;
  }
};
...
function getLayoutSegmentContext() {
  if (_LayoutSegmentCtx === null && typeof reactExports.createContext === "function") {
    _LayoutSegmentCtx = reactExports.createContext(0);
  }
...
let _cachedServerSearchParams = null;
...
async function handleSsr(rscStream, navContext, fontData) {
  return runWithNavigationContext(async () => {
    ...
    try {
      ...
      const { Fragment } = await Promise.resolve().then(() => React$1);
      let insertedHTML = "";
...
export {
  React$1 as R,
  React as a,
  getPrefetchedUrls as b,
  useRouter as c,
  requireReact as d,
  _virtual_vinextAppSsrEntry as default,
  createServerReference as e,
